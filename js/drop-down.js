...
function selectSwiper(obj) {
    ...
    _self.swiperData.activeIndex = 0;
    ...
    _self.init = function () {
        ...
        _self.selectSwiper = new Swiper(obj.el + ' .swiper-container', {
            ...
            onInit: function (swiper) {
                ...
                console.log(_self.swiperData.data);
        ...
        _self.el.find('.close').on('click', function () {
            _self.swiperData.activeIndex = _self.swiperData.activeIndex;
    ...
    _self.okSelectSwiper = function () {
        console.log(_self.swiperData.mustSelect);
        console.log(_self.swiperData.activeIndex);
